...
class OmniDiffusionConfig:
    ...
    def __post_init__(self):
        ...
        valid_policies = {"fcfs", "sjf", "sjf_aging", "sjf_aging_guarded", "size_bucket_sjf_aging", "slo_first", "p95-first", "p95-first-deadline", "p95-bucket-sjf", "p95-bucket-sjf-normalized", "slack_age", "slack_cost_age", "slack_hybrid"}
        ...
        if self.instance_scheduler_policy in {"p95-first", "p95-first-deadline", "p95-bucket-sjf", "p95-bucket-sjf-normalized", "slack_hybrid", "sjf_aging_guarded"}:
