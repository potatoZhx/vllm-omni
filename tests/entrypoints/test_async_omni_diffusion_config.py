...
@pytest.mark.parametrize("policy", ["p95-first", "sjf_aging", "sjf_aging_guarded", "sjf_aging_guarded_tail", "bypass_guard_sjf", "size_bucket_sjf_aging", "slack_age", "slack_cost_age", "slack_hybrid", "p95-fusion"])
...
def test_sjf_aging_guarded_tail_enables_step_chunk_and_chunk_preemption_by_default():
    from vllm_omni.diffusion.data import OmniDiffusionConfig

    config = OmniDiffusionConfig(instance_scheduler_policy="sjf_aging_guarded_tail")
