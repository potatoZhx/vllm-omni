...
def main() -> None:
    ...
    for row in rows:
        ...
        key = (
            ...
            row.get("vae_use_slicing"),
            row.get("vae_use_tiling"),
        ...
        out_rows.append(
            {
                "num_gpus": key[0],
                "parallel_name": key[1],
                "vae_use_slicing": key[2],
                "vae_use_tiling": key[3],
                "tensor_parallel_size": key[4],
                "ulysses_degree": key[5],
                "ring_degree": key[6],
                "cfg_parallel_size": key[7],
                "request_type_id": key[8],
                "height": key[9],
                "width": key[10],
                "num_frames": key[11],
                "num_inference_steps": key[12],
                "repeat_count": len(g),
